...
func CreateEmailSubscription(userId int64, allEmail bool, streak bool, pro bool, newsletter bool, inactivity bool, messages bool,
	referrals bool, promotional bool) (*EmailSubscription, error) {
...
func (i *EmailSubscription) ToSQLNative() []*SQLInsertStatement {
	...
	sqlStatements = append(sqlStatements, &SQLInsertStatement{
		Statement: "insert ignore into email_subscription(user_id, all_emails, streak, pro, newsletter, inactivity, messages, referrals, promotional) values(?, ?, ?, ?, ?, ?, ?, ?, ?);",
		Values:    []interface{}{i.UserId, i.AllEmails, i.Streak, i.Pro, i.Newsletter, i.Inactivity, i.Messages, i.Referrals, i.Promotional},
	})
